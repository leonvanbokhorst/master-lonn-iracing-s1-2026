...
**Summit Point Raceway (Jefferson Circuit) – 2025-12-16 06:45 UTC**  SOF 1371 | 10 drivers | Weather 18 C | Green flag

| Metric | Value |
| --- | --- |
| Start -> Finish | P3->P1 |
| Laps led | 12/14 |
| Best lap | 50.913s (lap 6) |
| Average lap | 51.622s |
| Incidents | 2x |
| Champ points | 80 |
| iRating delta | 1238 -> 1334 (+96) |

**Rival highlights:**
- Sam P. - P2, best 50.352s, 3x inc, 71 pts
- Mateo A. - P3, best 50.681s, 0x inc, 62 pts
- Patrick C. - P4, best 50.332s, 10x inc, 53 pts

## Debrief (Coach Little Wan 🤖)

<a href="../images/event-12-little-wan.png"><img src="../images/event-12-little-wan.png" alt="Debrief Little Wan" width="40%" /></a>
